...
public class UsefulClasses {
    public static void main(String[] args) {
        ...
        try {
            clazz = Class.forName("bibleofjava.Person"); // 클래스 이름으로부터 클래스 객체 참조 얻기
        ...
        // hashCode 생성: Object의 hashCode() 메서드는 인스턴스 메서드이므로 호출 전 널 체크가 필요, 아래 두 메서드는 불필요
        Objects.hashCode("1"); // 단일 파라미터
        Objects.hash("1", "2"); // 복수 파라미터
        // -- Objects --
